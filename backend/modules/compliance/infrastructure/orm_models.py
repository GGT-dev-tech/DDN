...
class ORMWasteManifest(Base):
    ...
    service_order_id: Mapped[uuid.UUID | None] = mapped_column(Uuid, index=True, nullable=True)
    ...
    usage_type: Mapped[MTRUsageType] = mapped_column(Enum(MTRUsageType, name="mtrusagetype"), default=MTRUsageType.SINGLE_USE, server_default="SINGLE_USE")
    current_usages: Mapped[int] = mapped_column(default=0, server_default="0")
