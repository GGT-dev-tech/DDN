...
import { LayoutDashboard, Route, Truck, Users, Settings, FileText, Library, Building2, CircleDollarSign, CalendarDays, ListChecks, Map, BriefcaseBusiness, ClipboardList, LogOut, MapPin } from 'lucide-react'
...
const GROUPED_NAVIGATION = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Locais de Destinação', icon: MapPin, href: '/admin/destinations' },
